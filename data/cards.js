...
export const CARDS = [
    ...
    /* ── 第8回 · お祝い・文化・買い物 ── */
    {lesson:8,cat:'culture',jlpt:'n4',type:'vocab',badge:'🎎 文化 · N4',
     front:'ご祝儀袋',audioFront:'ごしゅうぎぶくろ',reading:'ごしゅうぎぶくろ',
     def:'婚禮紅包袋（日式）',ex:'結婚式にご祝儀袋を持参しました。',exZh:'帶著婚禮紅包袋去參加婚禮。'},
    {lesson:8,cat:'culture',jlpt:'n4',type:'vocab',badge:'🎎 文化 · N4',
     front:'水引き',audioFront:'みずひき',reading:'みずひき',
     def:'和紙繩結（紅包袋裝飾）',ex:'赤白の水引きはお祝いを表します。',exZh:'紅白水引結代表慶祝之意。'},
    {lesson:8,cat:'culture',jlpt:'n4',type:'vocab',badge:'🎎 文化 · N4',
     front:'香典袋',audioFront:'こうでんぶくろ',reading:'こうでんぶくろ',
     def:'奠儀袋（喪禮用）',ex:'香典袋には古いお札を入れます。',exZh:'奠儀袋裡放舊鈔票。'},
    {lesson:8,cat:'culture',jlpt:'n4',type:'vocab',badge:'🎎 文化 · N4',
     front:'奇数 ／ 偶数',audioFront:'きすう ぐうすう',reading:'きすう / ぐうすう',
     def:'奇數 ／ 偶數',ex:'結婚祝いのお札の枚数は必ず奇数です。',exZh:'婚禮紅包的鈔票張數一定要是奇數。'},
    {lesson:8,cat:'culture',jlpt:'n4',type:'vocab',badge:'🎎 文化 · N4',
     front:'縁起が悪い',audioFront:'えんぎがわるい',reading:'えんぎがわるい',
     def:'不吉利',ex:'偶数は縁起が悪いと言われています。',exZh:'據說偶數是不吉利的。'},
    {lesson:8,cat:'daily',jlpt:'n4',type:'vocab',badge:'💬 日常 · N4',
     front:'実家',audioFront:'じっか',reading:'じっか',
     def:'老家、父母的家',ex:'お正月は実家に帰ります。',exZh:'過年回老家。'},
    {lesson:8,cat:'daily',jlpt:'n4',type:'vocab',badge:'💬 日常 · N4',
     front:'爆買い',audioFront:'ばくがい',reading:'ばくがい',
     def:'爆買（大量購物）',ex:'日本では皆爆買いします！',exZh:'在日本大家都爆買！'},
    {lesson:8,cat:'daily',jlpt:'n4',type:'vocab',badge:'💬 日常 · N4',
     front:'裾上げ',audioFront:'すそあげ',reading:'すそあげ',
     def:'修改褲腳長度',ex:'ユニクロでは裾上げが無料です。',exZh:'ユニクロ可以免費修改褲腳。'},
    {lesson:8,cat:'daily',jlpt:'n4',type:'vocab',badge:'💬 日常 · N4',
     front:'値札',audioFront:'ねふだ',reading:'ねふだ',
     def:'價格標籤',ex:'値札を見たら日本の方が安かったです。',exZh:'看了價格標籤，日本的比較便宜。'},
    /* ── 第8回 · 文法 ── */
    {lesson:8,jlpt:'n4',type:'gram',badge:'文法 · N4',
     front:'〜てもいいですか？',audioFront:'〜てもいいですか',reading:'',
     def:'可以〜嗎？（請求允許）',ex:'試着してもいいですか？',exZh:'可以試穿嗎？'},
    {lesson:8,jlpt:'n4',type:'gram',badge:'文法 · N4',
     front:'〜によって / 〜による',audioFront:'〜によって〜による',reading:'',
     def:'因〜而異（依據、差異）',ex:'渡す金額はその人の関係によって違います。',exZh:'包多少錢依關係親疏而異。'},
    {lesson:8,jlpt:'n4',type:'gram',badge:'文法 · N4',
     front:'〜に囲まれています',audioFront:'〜にかこまれています',reading:'',
     def:'被〜圍繞（環境狀態）',ex:'花蓮の実家は自然に囲まれています。',exZh:'花蓮老家被大自然圍繞。'},
  ];
